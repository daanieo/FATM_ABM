...
params = data.frame("alpha"=c(0.0,0.5,0.1),"gamma"=c(0.0,30.0,10.0)) # for ind hh testing iwthout startle
...
params_sample <- expand.grid(params_list$alpha,params_list$gamma)
...
# define number of replications per run
replications <- 1
