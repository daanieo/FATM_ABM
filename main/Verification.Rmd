...
p <- ggplot()+xlim(0,cycles_in_day*days_runtime) +theme+ ggtitle("Emotional state: alpha=[0.1 : 0.5] gamma=10") + labs(x="ticks [10 min]",y="Emotional state [-]",colour="alpha",size=(200))+scale_colour_gradient(low="lightblue",high="blue4")
for (s in 0:(samplesize-1)) {
  until<-as.numeric(until)
