...
experiment BatchWithoutStartle type: batch repeat: 1 keep_seed: true until: ( cycle > 10*24*6 ) {

	//parameter "No startle" var: startle <- false;
	...
	reflex t {
		...
		ask simulations {
			...
			save average_emotional_states to: "/home/daan/GAMA/workspace/results/household_verification/nostartle/ES" +"_alpha" +(alpha with_precision 10)
																					    	 +"_beta"  +(beta with_precision 1)
																					    	 +"_gamma" +(gamma)
																					    	 +"_zeta"  +(zeta with_precision 1)+".csv" type: "csv";
			save summed_food_storage to: "/home/daan/GAMA/workspace/results/household_verification/nostartle/FS" +"_alpha" +(alpha with_precision 10)
																					   		 +"_beta"  +(beta with_precision 1)
																					     	 +"_gamma" +(gamma)
																					     	 +"_zeta"  +(zeta with_precision 1)+".csv" type: "csv";																     
			save summed_demanded_food to: "/home/daan/GAMA/workspace/results/household_verification/nostartle/DF"+"_alpha" +(alpha with_precision 10)
																					     +"_beta"  +(beta with_precision 1)
																					     +"_gamma" +(gamma)
																					     +"_zeta"  +(zeta with_precision 1)+".csv" type: "csv";			
		}
...
experiment GoWithR type: gui {
	...
	output{monitor "avgemo" value: households mean_of each.emotional_state;
			monitor "uc" value: households sum_of each.unsatisfied_consumption;
