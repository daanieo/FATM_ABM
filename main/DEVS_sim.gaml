...
global {
//	System specifications: shapefile not made for zone 2 as an experiment 
	file shape_file_buildings <- shape_file("/home/daan/Documents/input_files/building_polygons/filtered/zone_2.shp","EPSG:4326");
...
//		Create facility agents
		create facilities number: 2 { //from: faccoordinates with: [facility_food_storage_size::read('Size')] { 
